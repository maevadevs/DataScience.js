...
So, in this repository, I make the assertion that we should focus more on bringing Data Science to the Web and the Web to Data Science. For that purpose, I assert that JavaScript can be made into a language that could address this linkage intention and I explore that possibility though research and resource gathering. 
